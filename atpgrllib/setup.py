...
DESCRIPTION = "Reinforcement Learning algorithms that can be used for Automated Test Pattern Generation (ATPG) and Design Verification (DV) of Integrated Circuits (ICs). The development has been with the help of gym/gymnasium development package."
