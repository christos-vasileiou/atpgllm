...
for path in sorted((REPO / "runs/grpo_granite_4.2_8b/fixed_eval").glob("step-*.json")):
    ...
    for r in payload["records"]:
        ...
        try:
            ...
            count["detection_exact_output_complete_inputs"] += detected and correct and set(netlist.input_nets).issubset(iv) and all(iv[k] in (0, 1) for k in netlist.input_nets)
