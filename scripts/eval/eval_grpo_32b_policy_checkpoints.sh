...
#   POLICY_FOLDER=grpo_32b_exper3/checkpoint-40 ./eval_grpo_32b_policy_checkpoints.sh
#   POLICY_FOLDER=grpo_32b_exper3/checkpoint-40/policy ./eval_grpo_32b_policy_checkpoints.sh
...
#   SAMPLING_METHOD=greedy NUM_COMPLETIONS=100 PASS_AT_K="1 5 10" ./eval_grpo_32b_policy_checkpoints.sh
