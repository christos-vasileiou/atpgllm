...
#   POLICY_FOLDER=sft_32b_exper1 ./eval_sft_32b_policy_checkpoints.sh
#   POLICY_FOLDER=sft_32b_exper1/checkpoint-40 ./eval_sft_32b_policy_checkpoints.sh
...
#
# Examples:
#   SAMPLING_METHOD=evolutionary NUM_COMPLETIONS=24 SEARCH_BUDGET=48 ./eval_sft_32b_policy_checkpoints.sh
#   SAMPLING_METHOD=greedy NUM_COMPLETIONS=32 PASS_AT_K="1 5 10 16" ./eval_sft_32b_policy_checkpoints.sh
